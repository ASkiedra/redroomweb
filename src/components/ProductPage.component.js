                        ...
                        <div style={{ paddingBottom: '8rem', minHeight: 'inherit' }} >
                                <div id="product-page-grid">
                                        ...
                                        <div style={{height: 'inherit', textAlign: 'center', maxWidth: 'inherit', maxHeight: 'inherit'}} id="container-1">
                                                ...
                                                {!this.state.loading && <img id="main-product-image" src={this.state.path + this.state.imageName[i]} style={{ maxHeight:'43rem', minWidth: 'inherit', width: 'auto', minHeight: '26rem',  fontSize: '0' }}  alt="main-product-photo" />}
