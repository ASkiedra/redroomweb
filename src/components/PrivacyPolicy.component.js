    ...
    return (
        <div id="privacy-policy-container">
            ...
            <div id="privacy-main-content-container">
                <h3>{props.language === "EN" ? 'PERSONAL DATA' : 'ASMENINIAI DUOMENYS'}</h3>
                <p>
                    {props.language === "EN" ? 'While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:'
                ...
                <ul>
                    <li>{props.language === "EN" ? 'email address;' : 'elektroninio pašto adresą;'}</li>
                    <li>{props.language === "EN" ? 'usage data.' : 'naudojimosi duomenis.'}</li>
                </ul>


                <h3>{props.language === "EN" ? 'SECURITY OF YOUR PERSONAL DATA' : 'JŪSŲ ASMENS DUOMENŲ SAUGUMAS'}</h3>
                <p>
                ...
                <h3>{props.language === "EN" ? 'YOUR RIGHTS' : 'JŪSŲ TEISĖS'}</h3>
                <p>
                    {props.language === "EN" ? 'We value Your privacy and agree to revoke Your consent, delete the data about You, provide a copy of data about You (if any data about You is stored) and know how the data is processed if You contact Us about it.'
                ...
                <h3>{props.language === "EN" ? "LINKS TO OTHER WEBSITES" : "NUORODOS Į KITAS SVETAINES"}</h3>
                <p>
                    {props.language === "EN" ? "Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the privacy policy of every site You visit. We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services."
            ...
            <ul style={{ marginTop: '1rem' }}>
                <li><a href="mailto:info@red-room.lt">{props.language === "EN" ? "by email:" : "el. paštu:"} info@red-room.lt</a></li>
                <li><a href="tel:+37064310657">{props.language === "EN" ? "by phone:" : "telefonu:"} +370 643 10 657</a></li>
            </ul>
        </div>
    )
}
